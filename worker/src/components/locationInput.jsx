        ...
        <div className="flex flex-col mb-4">
            ...
            <div className="relative mt-1">
                <input
                    ...
                    className={`block w-full border border-green-800 pl-3 pr-12 py-1 ${showMap ? "rounded-tl-md rounded-tr-md" : "rounded-md"} shadow-sm focus:outline-none focus:border text-black`}
                />
