    ...
    useEffect(() => {
        ...
        if (userData) {
            ...
            setProfile({
                ...
                aboutMe: parsedUserData.aboutMe || '',
            });
            ...
            <div className='flex flex-col items-center justify-center min-h-screen bg-gray-50 px-6'>
                ...
                <form onSubmit={handleSubmit} className="w-full max-w-lg">
                    ...
                    <div className="flex flex-col mb-1">
                        <label htmlFor="aboutMe" className="block text-sm font-medium text-gray-700">Write about yourself</label>
                        <textarea
                            id="aboutMe"
                            name="aboutMe"
                            className={`mt-1 block h-32 w-full border ${errors.aboutMe ? 'border-red-500' : 'border-gray-300'} p-1 rounded-md shadow-sm text-black`}
